...
interface Props { element: CircleElement }

export const CircleProperties = React.memo(({ element: el }: Props) => {
    const dispatch = useAppDispatch();
    const update = (changes: Partial<CircleElement>) => dispatch(updateElement({ id: el.id, changes: changes as Partial<typeof el> }));

    return (
        <AccordionItem value="style">
            <AccordionTrigger>Circle Style</AccordionTrigger>
            <AccordionContent>
